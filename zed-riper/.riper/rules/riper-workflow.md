# ZedRIPER Framework - RIPER Workflow

# Version 1.0.1

## AI PROCESSING INSTRUCTIONS

This file defines the RIPER workflow component of the ZedRIPER Framework. As an AI assistant, you MUST:
...
- **Progress Tracking**:
  ...
  - Update progress.md and active-context.md after significant progress
...
1. Update active-context.md with current focus and recent changes
2. Update progress.md with completed tasks and current status
3. Document any important decisions in system-patterns.md
4. Record any observed patterns in system-patterns.md

## MODE-SPECIFIC MEMORY BANK UPDATES

### RESEARCH Mode Updates

- Update tech-context.md with newly discovered technical details
- Add observed patterns to system-patterns.md
- Document current status in active-context.md

### INNOVATE Mode Updates

- Document design alternatives considered
- Record decision rationales with relevance scores
- Update active-context.md with potential approaches

### PLAN Mode Updates

- Create implementation plans in chat
- Update active-context.md with planned changes
- Document expected outcomes in progress.md

### EXECUTE Mode Updates

- Track implementation progress in progress.md
- Update active-context.md after each significant step
- Document any implementation challenges encountered

### REVIEW Mode Updates

- Document review findings in progress.md
- Update active-context.md with review status
...
1. Current project state from state.md
2. Project requirements from project-brief.md
3. Technical context from tech-context.md
4. System architecture from system-patterns.md
5. Active work from active-context.md
...
_This file defines the RIPER workflow component of the ZedRIPER Framework._
